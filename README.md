<<<<<<< HEAD
# Tokyo_Gender_Compile

## Overview
Analysis pipeline for 1942 Tokyo Metropolitan Personnel Records.

## Usage
1. Place raw scans in the Box directory.
2. Run `python process_scans.py`.
=======
...
```
>>>>>>> 1a4dbad (Clean commit of patched NDL OCR v2)
